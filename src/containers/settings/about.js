...
import {Linking,Image,TouchableOpacity,Text,View} from 'react-native';
import EStyleSheet from 'react-native-extended-stylesheet';
import {withNavigation} from 'react-navigation';

import Document from '../../../assets/ui/document.png';
	...
	<View style={styles.container}>
		...
		<View style={styles.list}>
			<TouchableOpacity style={styles.list_item} onPress={_=>Linking.openURL('http://api.emg.ru/Files/Terms_of_use_CCApp.pdf')}>
				<Image style={styles.list_image} source={Document} />
